...
.table-btn:hover, .track-btn:hover {
    background: #1e40af;
}
...
<div class="container">
    ...
    // Animation des cartes et tableau au chargement
    ...
    const buttons = document.querySelectorAll('.btn, .profile-link, .logout-btn, .table-btn, .track-btn');
