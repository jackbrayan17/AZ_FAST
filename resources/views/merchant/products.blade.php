...
<div class="container">
        ...
        <div class="action-section">
            <a href="{{ route('merchant.products.create') }}" class="btn add-btn">Ajouter un Nouveau Produit</a>
        </div>
                ...
                <tbody>
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td>{{ $product->stock }}</td>
                            <td>
                                <a href="{{ route('merchant.products.edit', $product->id) }}" class="btn edit-btn">Modifier</a>
